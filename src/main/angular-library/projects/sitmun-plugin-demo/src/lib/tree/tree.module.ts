...
//Define module name (for angular app component downgrade)
export const TREE_MODULE_NAME = 'treeModule';

export const angularTreeModule = angular.
    ...
    $rootScope.loadBackgroundsConfiguration = function(backgrounds) {
        if (backgrounds) {
            ...
            if (configuration.layersConfiguration != null) {
              ...
              if (configuration.topicsConfiguration != null) {
                gaTopic.updateBaseGroupsConfiguration(configuration.topicsConfiguration);
              }
            }
        }
