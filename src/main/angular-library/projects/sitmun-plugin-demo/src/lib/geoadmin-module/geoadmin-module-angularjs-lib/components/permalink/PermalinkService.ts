import * as angular from 'angular';
  ...
  module.provider('gaPermalink', function() {
    this.$get = function($window, $rootScope, gaHistory, gaUrlUtils, gaGlobalOptions) {
      ...
      var Permalink = function(b, p) {
        ...
        this.getHref = function(p) {
		  //Check if the tree state storage in the navigation url has been disabled
          if (!gaGlobalOptions.permalinkDisabled) {
